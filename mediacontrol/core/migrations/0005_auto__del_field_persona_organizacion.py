...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Persona.organizacion'
        db.delete_column('core_persona', 'organizacion')


    def backwards(self, orm):
        
        # Adding field 'Persona.organizacion'
        db.add_column('core_persona', 'organizacion', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)
