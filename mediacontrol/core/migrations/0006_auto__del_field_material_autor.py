...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Material.autor'
        db.delete_column('core_material', 'autor')


    def backwards(self, orm):
        
        # Adding field 'Material.autor'
        db.add_column('core_material', 'autor', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
